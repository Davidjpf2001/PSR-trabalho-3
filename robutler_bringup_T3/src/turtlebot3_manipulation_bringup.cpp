...
#include "robutler_bringup_T3/robutler_bringup_T3.h"


Robutler_BringUp_T3::Robutler_BringUp_T3()
: nh_(""),
  arm_action_server_(nh_, 
    "arm_controller/follow_joint_trajectory", 
    boost::bind(&Robutler_BringUp_T3::armActionCallback, this, _1), 
    false),
  gripper_action_server_(nh_, 
    "gripper_controller/follow_joint_trajectory", 
    boost::bind(&Robutler_BringUp_T3::gripperActionCallback, this, _1), 
    false)
{
  // Init Publisher
...
void Robutler_BringUp_T3::armActionCallback(const control_msgs::FollowJointTrajectoryGoalConstPtr &goal)
{
...
void Robutler_BringUp_T3::gripperActionCallback(const control_msgs::FollowJointTrajectoryGoalConstPtr &goal)
{
  trajectory_msgs::JointTrajectory jnt_tra = goal->trajectory;
  std_msgs::Float64MultiArray jnt_tra_pts;
...
{
  ros::init(argc, argv, "robutler_bringup_T3");
  Robutler_BringUp_T3 robutler_bringup_T3;
  ros::spin();
  return 0;
}
